                                ...
                                <div class="col-sm-7 b-r">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <?php echo $this->Form->control('name', array('type'=>'hidden', 'value'=>$driverUnapproved->full_name)); ?>
                            ...
                            <div class="row">
                                <div class="col-sm-7 b-r">
                                    ...
                                    <div class="row">
                                        <br>
                                        <div class="col-md-6">
                                            <?php echo $this->Form->control('password',['id'=>'passfield', 'label'=>'Contraseña para el chofer','type'=>'password','class'=>'form-control','required'=>true]); ?>
