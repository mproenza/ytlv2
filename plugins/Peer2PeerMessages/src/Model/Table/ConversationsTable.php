...
class ConversationsTable extends Table
{
    ...
    {
        $defaults = [
            'peer1_table_relationship' => [
                'alias'=>'Peers1', 
                'relationship' =>['foreignKey' => 'peer1_id']],
            
            'peer2_table_relationship' => [
                'alias'=>'Peers2', 
                'relationship' =>['foreignKey' => 'peer2_id']],
        ];
        ...
        $this->belongsTo($config['peer1_table_relationship']['alias'], [
            'foreignKey' => $config['peer1_table_relationship']['relationship']['foreignKey'],
            'joinType' => 'INNER',
        ]);
        ...
        $this->belongsTo($config['peer2_table_relationship']['alias'], [
            'foreignKey' => $config['peer2_table_relationship']['relationship']['foreignKey'],
            'joinType' => 'INNER',
        ]);
        ...
        */
        foreach($config['meta_relationships'] as $otherRels) {
            $this->belongsTo($otherRels['alias'], [
                'foreignKey' => $otherRels['relationship']['foreignKey'],
            ]);
        }
