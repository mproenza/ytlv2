...
.nav-header {
	...
	background: linear-gradient(to bottom, #005067, transparent);
}
...
.profile-element:before {
	display: block;
	content: ' ';
	width: 160px;
	height: 48px;
	background: url(../img/logo_energy_sequence.png) no-repeat 0 0;
	margin-bottom: 30px;
}
.minimalize-styl-2 {
	padding: 4px 12px;
...
.landing-page .features-box img {
	margin-bottom: 15px;
}
.landing-page .features-box ul,
.landing-page .features-box li {
	list-style: none;
	margin: 0;
	padding: 0;
}
...
.footable .pagination > li:last-child > a, .pagination > li:last-child > span {border-radius: 0 15px 15px 0;}
.footable .pagination > li:first-child > a, .pagination > li:first-child > span {border-radius: 15px 0 0 15px;}
