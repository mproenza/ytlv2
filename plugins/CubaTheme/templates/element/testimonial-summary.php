<div class="team-item col-lg-3 col-md-6">
    ...
    <div class="item-caption py-3">
        <div class="item-name px-2">
            <p class="mbr-fonts-style display-7"><?php echo __d('mobirise/testimonials', '{0} sobre {1}', $testimonial['author'], $driver['DriverProfile']['driver_name'])?><br><br></p>
            ...
            else $daysPosted = __d('mobirise/testimonials', 'Hace {0} días', $daysPosted);
            */
            ?>
